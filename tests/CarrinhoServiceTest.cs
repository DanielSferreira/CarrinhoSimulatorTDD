...
namespace tests
{
    public class CarrinhoServiceTest
    {
        ...
        public void UpdatePrecoTest_GaranteSoma()
        {
            ...
            carrinho.UpdateCarrinho().Should().Be(execpt,"Precisa Adicionar um produto correto ao carrinho");
        }
        [Fact]
        public void UpdatePrecoTest_GaranteSomaPositiva()
        {
            ...
            carrinho.AddToCarrinho(prd1);
            carrinho.AddToCarrinho(prd2);
            carrinho.UpdateCarrinho().Should().BePositive("Precisa Adicionar um produto correto ao carrinho");
        }
    }
} 